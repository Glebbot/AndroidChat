...
import com.example.androidchat.databinding.ItemContainerReceivedMessageBinding;
import com.example.androidchat.databinding.ItemContainerSentMessageBinding;
...
public class ChatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public int getItemViewType(int position) {
        if (chatMessages.get(position).senderName.equals(senderName)) {
    ...
    static class ReceivedMessageViewHolder extends RecyclerView.ViewHolder {
        ...
        void setData(ChatMessage chatMessage){
            binding.textMessage.setText(chatMessage.message);
            binding.textDateTime.setText(chatMessage.datetime);
            binding.textSenderName.setText(chatMessage.userName);
        }
    }
